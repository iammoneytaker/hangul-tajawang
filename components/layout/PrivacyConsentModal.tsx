...
export const PrivacyConsentModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-zinc-950/80 backdrop-blur-xl flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl border border-zinc-200 animate-in zoom-in duration-500">
            ...
            <>
              ...
              <div className="w-full space-y-4 mb-10">
                <button 
                  ...
                  className="w-full flex items-center justify-between p-4 bg-zinc-50 rounded-2xl group hover:bg-zinc-100 transition-colors"
                >
                ...
                >
                  <div className={`w-6 h-6 rounded-lg flex items-center justify-center transition-all ${
                    accepted ? "bg-blue-600 text-white" : "bg-zinc-100 text-transparent"
                  }`}>
