...
export const metadata: Metadata = {
  title: '오늘의 지식타자 5문제',
  description: '수도·역사·과학을 매일 다섯 문제씩 타자로 익혀보세요. 헷갈린 문제는 다음날 복습하고, 중간에 멈춰도 이어서 풀 수 있습니다.',
...
export default function DailyJourneyPage() {
  return <div className="mx-auto w-full max-w-2xl px-4 py-8 sm:py-12">
    <header className="mb-6">
      ...
      <p className="mt-3 text-sm sm:text-base text-secondary leading-relaxed">세계의 수도, 조선 왕조, 주기율표를 한글로 입력하며 익혀보세요. 헷갈린 문제는 다음날부터 복습 문제로 다시 만납니다.</p>
    </header>
    <DailyJourney />
