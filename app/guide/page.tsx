...
import { Keyboard, Layout, PenTool, Gamepad2, BookOpenCheck, Users, ChevronRight, CheckCircle2, HelpCircle } from "lucide-react";
    ...
    <div className="w-full max-w-5xl mx-auto py-16 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <GuideSection
          ...
          title="필사 챌린지 (Transcription Challenge)"
          desc="직접 감성 문장이나 글을 등록하고 다른 유저들과 공유하세요. 커뮤니티가 직접 참여하는 유저 생성 타자 연습 시스템입니다."
          href="/challenge"
        />
        <GuideSection
          icon={<HelpCircle className="text-red-500" />}
          title="맞춤법 퀴즈 (Spelling Quiz)"
          desc="한국인도 가장 자주 헷갈리는 필수 맞춤법을 재미있는 퀴즈로 풀고, 올바른 표기법을 학습하여 완벽한 타이핑을 준비하세요."
          href="/quiz"
        />
      </div>
